"""
Django settings for woah_41921 project.
...
WSGI_APPLICATION = 'woah_41921.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "woah_41921 API",
    "DESCRIPTION": "API documentation for woah_41921 App",
    "VERSION": "v1",
}
